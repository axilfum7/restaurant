    ...
    <section className='hero-section'>
      <div className="containers hero-bg pt-13.75 h-180 relative pb-25 px-17.5 rounded-[50px]">
        ...
        <div className='w-82 pt-45.25 pb-25'>
          ...
          <Image className='absolute bottom-0 m-auto right-40 pt-24 z-index pointer-events-none top-0 scale-[1.6]' style={{ width: "auto", height: "auto" }} src="/images/hero-bg.png" alt="Hero bg" width={1000} height={732} />
          ...
          <button className="bg-black text-white px-10 py-4 rounded-xl flex items-center gap-3 hover:bg-[#FFD903] hover:text-black duration-300 font-bold uppercase text-[14px] group">
      Посмотреть меню 
